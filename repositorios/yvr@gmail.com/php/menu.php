<div id="menu">
    ...
    <ul>
        ...
        <li><a href="dashboard.php?descripcion"><i class="bi bi-card-text"></i> Descripción</a></li>
        <li><a href="dashboard.php?objetivos"><i class="bi bi-bullseye"></i> Objetivos</a></li>
        <li><a href="dashboard.php?recursosh"><i class="bi bi-people"></i> Recursos Humanos</a></li>
