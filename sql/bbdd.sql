...
INSERT INTO `recursosh` (`cod_Recurso`, `descripcion`, `horas`, `precio`, `id_Alumno`) VALUES
(7, 'Equipo de desarrollo: Programadores web, diseñadores UX/UI', 15, 16, 5);
...
INSERT INTO `recursosm` (`cod_Recurso`, `descripcion`, `meses`, `precio`, `id_Alumno`) VALUES
(4, 'Internet: Contrato mensual Fibra 1Gb', 3, 29, 5),
(5, 'Dominio: dominio para apuntar los DNS al servidor.', 3 ,10, 5),
(6, ' Servidor: alquiler de servidor en AWS (Amazon Web Service) para el almacenamiento de la web', 3, 5, 5),
(7, 'Ordenador: portátil para poder trabajar desde el trabajo y en caso en el proyecto', 1, 800, 5),
(8, 'Curso formativo AWS', 1, 16, 5);
